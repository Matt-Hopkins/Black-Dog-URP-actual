...
public class Transfer1o2 : MonoBehaviour
{
    ...
    void NumCounter_Lv1()
    {
       if (counter_BD == 12 && counter_HD == 3)
       {
        transferWaiting += Time.deltaTime;
       }
       
       if (counter_BD == 12 && counter_HD == 3 && transferWaiting >= transferWaitingTime)
       {
        EndLevel1 = 1;
       }
       
       if (counter_BD == 4 && counter_HD == 1)
       {
            timerWave1to2 += Time.deltaTime;
       }

       if (counter_BD == 4 && counter_HD == 1 && timerWave1to2 >= Wave2WaitingTime)
       {
        EnemyGroup_2.SetActive(true);
       }

       if (counter_BD == 8 && counter_HD == 2)
       {
            timerWave2to3 += Time.deltaTime;
       }

       if (counter_BD == 8 && counter_HD == 2 && timerWave2to3 >= Wave3WaitingTime)
       {
