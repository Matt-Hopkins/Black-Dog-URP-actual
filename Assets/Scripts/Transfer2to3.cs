...
public class Transfer2to3 : MonoBehaviour
{
    ...
    void NumCounter_Lv1()
    {
       if (counter_BD == 15 && counter_HD == 6)
       {
        transferWaiting += Time.deltaTime;
       }
       
       if (counter_BD == 15 && counter_HD == 6 && transferWaiting >= transferWaitingTime)
       {
        EndLevel1 = 1;
       }
       
       if (counter_BD == 5 && counter_HD == 2)
       {
            timerWave1to2 += Time.deltaTime;
       }

       if (counter_BD == 5 && counter_HD == 2 && timerWave1to2 >= Wave2WaitingTime)
       {
        EnemyGroup_2.SetActive(true);
       }

       if (counter_BD == 10 && counter_HD == 4)
       {
            timerWave2to3 += Time.deltaTime;
       }

       if (counter_BD == 10 && counter_HD == 4 && timerWave2to3 >= Wave3WaitingTime)
       {
